...
public class WeekBasedStatusManager {
                ...
                newMaterialCapacityQuantities.forEach(
                    newCapacityQuantity -> {
                        if (
                            ...
                            EventType eventType = getEventTypeFromColor(oldCapacityQuantity, newCapacityQuantity);
