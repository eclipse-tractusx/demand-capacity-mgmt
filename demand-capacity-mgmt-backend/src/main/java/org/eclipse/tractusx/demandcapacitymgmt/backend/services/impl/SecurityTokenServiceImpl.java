...
import eclipse.tractusx.demandcapacitymgmt.specification.model.Role;
import eclipse.tractusx.demandcapacitymgmt.specification.model.TokenResponse;
        ...
        if (rolesObject instanceof List<?>) {
            ...
            for (Object roleObj : list) {
                if (roleObj instanceof String) {
                    ...
                    try {
                        org.eclipse.tractusx.demandcapacitymgmt.backend.entities.enums.Role role =
                            org.eclipse.tractusx.demandcapacitymgmt.backend.entities.enums.Role.valueOf(roleStr);
