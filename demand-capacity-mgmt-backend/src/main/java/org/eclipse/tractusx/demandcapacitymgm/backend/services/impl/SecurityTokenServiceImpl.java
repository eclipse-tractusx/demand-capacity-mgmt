...
import eclipse.tractusx.demandcapacitymgm.specification.model.Role;
import eclipse.tractusx.demandcapacitymgm.specification.model.TokenResponse;
        ...
        if (rolesObject instanceof List<?>) {
            ...
            for (Object roleObj : list) {
                if (roleObj instanceof String) {
                    ...
                    try {
						org.eclipse.tractusx.demandcapacitymgm.backend.entities.enums.Role role =
							org.eclipse.tractusx.demandcapacitymgm.backend.entities.enums.Role.valueOf(
								roleStr
							);
