                ...
                <Row>
                    <Col md={2} className="tabs-column">
                        <Nav variant="pills" className="flex-column">
                            ...
                            <Nav.Item>
                                <Nav.Link className='admin-nav-link' eventKey="thresholdConfig" active={activeTab === 'thresholdConfig'} onClick={() => setActiveTab('thresholdConfig')}>
                    ...
                    <Col md={10}>
                        <TabContent>
                            ...
                            <Tab.Pane eventKey="thresholdConfig" className={`tab-pane fade ${activeTab === 'thresholdConfig' ? 'show active' : ''}`}>
                                <ThresholdPage/>
                            </Tab.Pane>
                        </TabContent>
                    </Col>
